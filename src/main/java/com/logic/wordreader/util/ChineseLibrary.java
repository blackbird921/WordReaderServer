 ...
 */
public class ChineseLibrary {

    static String PATH = "D:\\prj-mobile\\WordReaderServer\\docs\\audio_man\\";

    static Map<String, String> mapUtf8 = new HashMap<String, String>();
    static {
        mapUtf8.put("ā","a1");
        mapUtf8.put("á","a2");
        mapUtf8.put("ǎ","a3");
    ...
    public static List<String> getAllPinYinExampleChar() {
        ...
        map.put("bai1  ".trim(),"掰");
        map.put("bie1  ".trim(),"瘪");
        map.put("cang2 ".trim(),"藏");
        map.put("ceng1 ".trim(),"噌");
        map.put("ceng4 ".trim(),"蹭");
        map.put("chen3 ".trim(),"碜");
        map.put("chong3".trim(),"宠");
        map.put("chuai1".trim(),"搋");
        map.put("cuan1 ".trim(),"蹿");
        map.put("dian3 ".trim(),"屌");
        map.put("feng3 ".trim(),"讽");
        map.put("hang1 ".trim(),"夯");
        map.put("hong3 ".trim(),"哄");
        map.put("huan1 ".trim(),"欢");
        map.put("huang4".trim(),"晃");
        map.put("huo1  ".trim(),"豁");
        map.put("jiao2 ".trim(),"嚼");
        map.put("jue1  ".trim(),"撅");
        map.put("jue4  ".trim(),"倔");
        map.put("kou1  ".trim(),"抠");
        map.put("lian1 ".trim(),"撩");
        map.put("lun1  ".trim(),"抡");
        map.put("miao1 ".trim(),"喵");
        map.put("niu4  ".trim(),"拗");
        map.put("qia1  ".trim(),"掐");
        map.put("qiang4".trim(),"跄");
        map.put("sa3   ".trim(),"洒");
        map.put("sang4 ".trim(),"丧");
        map.put("sao4  ".trim(),"臊");
        map.put("sha2  ".trim(),"啥");
        map.put("sui3  ".trim(),"髓");
        map.put("ti3   ".trim(),"体");
        ...
        map.put("wai3  ".trim(),"崴");
        map.put("zan3  ".trim(),"攒");
        map.put("zeng4 ".trim(),"赠");
        map.put("zhao2 ".trim(),"着");
        map.put("zuo1  ".trim(),"嘬");
...
//            System.out.println(key+"="+map.get(key));
        ...
        System.out.println("===========================================");
        System.out.println();
        String wordsToRead = "参差 恶心 蛮横 模子 切开 色子";

        List<String> missingPinyin = new ArrayList<String>();
        for (String key: list){
            String prefix = key.replaceAll("\\d", "");
            for (int i = 1; i <= 4; i++) {
                if (!list.contains(prefix + i)) {
                    if (!missingPinyin.contains(prefix + i)) {
                        missingPinyin.add(prefix + i);
                    }
                }
            }
        }
        ...
        for (String s : missingPinyin) {
//            System.out.println(s);
        }

        System.out.println(list.size());
        System.out.println(missingPinyin.size());
        return list;
    }

    public static void renameAudioFiles() {
        List<String> sortedPinyins = getAllPinYinExampleChar();
        File folder = new File(PATH);
        int index = 0;
        for(File file :folder.listFiles()){
            System.out.println(file.getAbsolutePath()+"-------------"+PATH + sortedPinyins.get(index)+".mp3");
            file.renameTo(new File(PATH + sortedPinyins.get(index)+".mp3"));
            index++;
        }

    }

    public static String pinyinUtf8ToNumber(String pyUtf8) {
        String number = pyUtf8;
    ...
    public static String pinyinNumberToUtf8(String pyNumber) {
        String utf8 = "";
        return utf8;
    }

    public static void main(String[] args) throws Exception{
//        getAllPinYinExampleChar();
        renameAudioFiles();
    }
}
